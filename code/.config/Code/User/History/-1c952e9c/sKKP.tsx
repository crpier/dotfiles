...
export default function TopPosts() {
  ...
  const [posts, { mutate, refetch }] = createResource<Post[]>((_, info) => {
    if (info.refetching instanceof Number) {
      console.log("not getting all")
      return storeActions.getPost(info.refetching);
    }
