...
export default function TopPosts() {
  ...
  return (
    <For fallback={<p class="text-white">Loading post...</p>} each={posts()}>
      {(post, i) => (
          ...
          <div class="mt-8 border-2 border-gray-600 px-6 pb-6 text-center bg-[#101010]">
            ...
            <div class="flex flex-grow-0 flex-row items-center justify-start">
              <button
                ...
                onClick={(e) => {
                  storeActions.likePost(post.id);
                  e.target.classList.add("bg-orange-800");
                }}
              >
                <ImArrowUp size={"1rem"} />
                {post.liked}
              ...
              <button
                ...
                onClick={() => storeActions.dislikePost(post.id)}
              >
